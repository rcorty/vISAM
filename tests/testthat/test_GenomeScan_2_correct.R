...
gs <- GenomeScan$new(y = y, X = covariate_mat, G = locus_list, K = kinship_mat)
wgs <- GenomeScan$new(y = y, X = covariate_mat, G = locus_list, K = kinship_mat, w = 1/se_mean_per_strain^2)
